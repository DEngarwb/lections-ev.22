...
# if len(new_set) < 20:
#     print(f'в этом сете было {20- len(new_set)} повторения, его длина состовляет{len(new_set)} ')
# else:
#     print("ваше объединеное множество было уникальным!")
...
# result = {key: value for key, inner in my_dict.items() for value in inner.values()}
# print(result)
# my_dict = {'first':{'a':1}, 'second': {'b': 2}}
