...
# 8. git clone - комманда которая создает не пустой локальный репозиторий, который мы склонировали с удаленного репозитория в гитхаб

# git clone <ссылка на репозиторий>

# 9. git pull - комманда которая используется для загрузки изменений дибо же обновленний из удаленного репощмтория 
